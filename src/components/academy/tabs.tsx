  ...
  return (
    <Box sx={{ width: '70%', m: 10 }}>
      ...
      <CustomTabPanel value={value} index={0}>
        His Grace Christian Academy, Aurora, IL His Grace Christian Academy, Aurora facility is designed like home to
        feel like home. Helping children develop and learn through fun and creativity.
      </CustomTabPanel>
